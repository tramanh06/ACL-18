...
public class StatesTimesReviewWrapper extends Wrapper {
  ...
  public Article parse(Document jsoupDocument) {
    ...
    String portal = "States Times Review";
  ...
  private String getTitle(Document jsoupDocument) {
    return jsoupDocument.select("h1.post-title.single-post-title").text();
  }
  ...
  public boolean isValidUri(String targetUri) {
    return targetUri.contains("statestimesreview.com/");
  }

  public static void main(String[] args) throws IOException, JAXBException {
    String url = "http://statestimesreview.com/2016/10/21/law-minister-k-shanmugam-eurasian-singaporeans-are-indians/";
    ...
    StatesTimesReviewWrapper st = new StatesTimesReviewWrapper();
    Article article = st.parse(doc);

    System.out.println("author = "+ article);

    File f = new File("StatesTimesSample.xml"); 
    article.write(f);
  }
}
